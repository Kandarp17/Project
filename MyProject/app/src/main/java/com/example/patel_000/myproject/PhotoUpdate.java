...
public class PhotoUpdate extends AppCompatActivity implements View.OnClickListener {
    ImageButton imgCamera, imgGallery;
    ImageView ivDisplay;
    Button submit;
    EditText et;
    ...
    String PercentageCompletion, PhotoPath,unm,pass, projectid;
    Bitmap bm1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // cameraPhoto = new CameraPhoto(getApplicationContext());
        ...
        et = (EditText) findViewById(R.id.etPercentage);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                ...
                Path = getPath(selectedImageUri, PhotoUpdate.this);
    ...
    public void onClick(View v) {
        ...
        if (v == submit) {
           ...
           WebTask wt = new WebTask();
            wt.execute(et.getText().toString());
    ...
    private class WebTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(PhotoUpdate.this);
        ...
        protected String doInBackground(String... arr) {
            ...
            rp.setUri(getResources().getString(R.string.url) + "/NewPhoto/NewPhoto");
            rp.setMethod("POST");
            BitmapFactory.Options btmapOptions = new BitmapFactory.Options();
            ...
            rp.setParam("Username", unm);
            rp.setParam("Password", pass);
            rp.setParam("PhotoPath", image_str);
            rp.setParam("Feedback", arr[0]);
        ...
        protected void onPostExecute(String ans) {
            ...
            if (ans.startsWith("Image Uploaded")) {
                Intent i = new Intent(PhotoUpdate.this, MainActivity.class);
                startActivity(i);
            } else {
                Toast.makeText(PhotoUpdate.this, ans+"Something went wrong try again later.. ", Toast.LENGTH_LONG).show();
            }
        }
    }
